...
**PRO — 799 ₽/мес**
- Всё из STARTER +
- Flux.1 Pro + DALL-E 3 (изображения)
- До 100 запросов/день
- Промпт-генератор, приоритетная поддержка, еженедельные вебинары

**VIP / LIFETIME — 3999 ₽ разово**
- Всё из PRO +
- Runway Gen-3 (видео)
- Безлимит (5000+ запросов/день)
- Ранний доступ к новым моделям, личный чат с разработчиком, экспорт в высоком качестве, пожизненные обновления
